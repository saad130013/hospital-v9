...
import { FileDown, Filter, PieChart } from 'lucide-react';
...
const ReportingHub: React.FC = () => {
    ...
    // Printing logic
    useEffect(() => {
        const isPrinting = generatingSummaryReport !== null || generatingInspectorReport;
    ...
    }, [generatingSummaryReport, generatingInspectorReport]);
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                    <Card>
                        <h2 className="text-xl font-bold text-brand-blue-dark dark:text-brand-green mb-4">{t('allReports')}</h2>
                                ...
                                <tbody>
                                    {filteredReports.map(report => (
                                        <tr key={report.id} className="bg-white dark:bg-gray-800 border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                                            ...
                                            <td className="px-6 py-4">{getLocationById(report.locationId)?.name}</td>
